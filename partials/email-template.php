                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600" align="center" class="wrapper">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#ffffff">
                                <tr>
                                    <td align="left" style="padding:40px 30px 40px; font-size:20px;">
                                        <div style="font-size:30px; font-weight:bold;">Thanks [name],</div>
                                        <br>
                    ...
                    <tr>
                        <td align="left" valign="top" style="padding: 20px 0; font-size: 10px;">
                            This email was sent to you because your email [email] was entered in the contact form located <a href="<?php echo get_permalink(11); ?>">here</a>.
                            <br><br>
...
echo wp_mail($to, $subject, $content, $headers); ?>